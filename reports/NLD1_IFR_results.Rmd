...
# read in data
#......................
modout <- readRDS("results/ModFits/NLD1_age_GTI3_rung50_burn1000_smpl1000.RDS")
```
...
NLD1rcrudedat <- dscdat %>% 
  dplyr::filter(study_id == "NLD11" & breakdown == "ageband")  %>%
...
dscdat <- readRDS("data/derived/descriptive_results_datamap.RDS") 
NLD1rcrudedat <- dscdat %>% 
  dplyr::filter(study_id == "NLD11" & breakdown == "region")  %>%
  dplyr::select(c("study_id", "plotdat")) %>%
  tidyr::unnest(cols = "plotdat")
