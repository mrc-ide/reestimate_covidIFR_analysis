...
simnm <- sub("_SeroRev.RDS", "", basename(params$path))
simnm <- sub("_NoSeroRev.RDS", "", basename(params$path))
...
# `r paste0("Simulation run: ", simnm)`

## Fit Diagnostics
#### Log Plot & Metropolis Coupling Acceptance Plot
```{r, results='asis', fig.width=6.5, fig.height=7.5}
#......................
# like and mc accept
#......................
...
pB <- serocurvedat %>% 
  ...
  geom_rect(aes(xmin = 135, xmax = 145, ymin = 0, ymax = Inf), 
            alpha = 0.3, color = "#bdbdbd", fill = "#bdbdbd") + 
