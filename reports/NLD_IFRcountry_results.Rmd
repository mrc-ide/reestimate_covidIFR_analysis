...
# read in data
#......................
modout <- readRDS("results/temp_slurm_worker_results/_rslurm_NLDfits/results_0.RDS")[[1]]
...
# out
jpeg("figures/NLD_ifr_plot_age.jpg", width = 11, height = 8, units = "in", res = 500)
main_plotObj
graphics.off()
...
# out
jpeg("figures/NLD_ppc_plot_age.jpg", width = 11, height = 8, units = "in", res = 500)
ppc_plot_age
graphics.off()
...
<!-- # read in data -->
<!-- #...................... -->
<!-- modout <- readRDS("results/temp_slurm_worker_results/_rslurm_ESPregion/results_0.RDS")[[1]] -->
<!-- rgnkey <- readRDS("data/derived/ESP/ESP_rgn_key.RDS") %>%  -->
