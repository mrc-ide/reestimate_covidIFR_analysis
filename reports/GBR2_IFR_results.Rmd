...
# read in data
#......................
modout <- readRDS("results/ModFits/GBR_age_GTI3_rung50_burn1000_smpl1000.RDS")
```
...
# read in data
#......................
modout <- readRDS("results/ModFits/GBR_rgn_GTI3_rung50_burn1000_smpl1000.RDS")
```
...
dscdat <- readRDS("data/derived/descriptive_results_datamap.RDS") 
GBRcrudedat <- dscdat %>% 
  dplyr::filter(study_id == "GBR1" & breakdown == "region")  %>%
  dplyr::select(c("study_id", "plotdat")) %>%
  tidyr::unnest(cols = "plotdat")
