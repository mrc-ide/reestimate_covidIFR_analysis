...
# pieces for below
studyidchar <- toupper(stringr::str_split(basename(params$path), "_", simplify = T)[[1]])
...
#......................
death_midday <-  modout$inputs$IFRmodel$data$obs_deaths %>%
...
ppc_plot <- ggplot() +
  ...
  facet_wrap(.~strata) +
  theme_bw() +
  ggtitle(caption = "Grey Lines are Draws from Posterior, Blue Line is Observed Data (from ECDC)") +
