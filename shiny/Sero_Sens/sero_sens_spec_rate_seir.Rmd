...
#............................................................
# Basic Incidence Curve wrapper
#...........................................................
wrap_infxn_curve <- function(beta, popN, time) {
  infxns <- lapply(1:100, function(x){
    run_simple_seir(N = popN,
                    E0 = 50,
                    R0 = 0,
                    betas = c(beta, beta * 0.8, beta * 0.5),
                    beta_changes = c(1, time*0.75, time*0.8),
                    sigma = 0.2,
                    gamma = 0.2,
                    time = time)
  })
...
inputPanel(
  ...
  sliderInput("time", label = "Days of Epidemic",
              min = 1e2, max = 1e3, value = 2e2, step = 1e2),
  
  sliderInput("beta", label = "Beta (Effective Contact Rate)",
              min = 0, max = 0.33, value = 0.2, step = 0.01),
...
renderPlot({ withProgress(message = 'Making plot', {
  ...
  # basic infections
  #...........................................................
  infxns <- wrap_infxn_curve(beta = input$beta, popN = popN, time = input$time)
  if(sum(infxns$infxns) > popN) {stop("Too many infections for this population. Lower beta")}
  #..............................................................
  # sim
  #..............................................................
