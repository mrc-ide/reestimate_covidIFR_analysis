...
# simulation fits
sbatch -n 1 --time=5-00:00:00 --mem=24g --wrap="Rscript analyses/SimWork/SimCurves_drakeworker_v2.R"
sbatch -n 1 --time=5-00:00:00 --mem=24g --wrap="Rscript analyses/SimWork/SeroRev_SimCurves_drakeworker_v2.R"
