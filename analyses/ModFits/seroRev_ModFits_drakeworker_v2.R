...
BRA5_rgn_mod <- make_SeroRev_IFR_model_fit(num_mas = 1, maxMa = "ma1",
...
DNK_basic_mod <- make_SeroRev_IFR_model_fit(num_mas = 1, maxMa = "ma1",
                                          groupvar = "region",  dat = rawbase,
...
SWE_basic_mod <- make_SeroRev_IFR_model_fit(num_mas = 1, maxMa = "ma1",
                                            groupvar = "region",  dat = rawbase,
                                            num_xs = 4, max_xveclist = list("name" = "x4", min = 219, init = 226, max = 233, dsc1 = 219, dsc2 = 233),
...
LACA_basic_mod <- make_SeroRev_IFR_model_fit(num_mas = 1, maxMa = "ma1",
                                             groupvar = "region",  dat = rawbase,
                                             num_xs = 4, max_xveclist = list("name" = "x4", min = 219, init = 226, max = 233, dsc1 = 219, dsc2 = 233),
...
NYC_age_mod <- make_SeroRev_IFR_model_fit(num_mas = 5, maxMa = "ma5",
                                          groupvar = "ageband",  dat = rawage,
                                          num_xs = 4, max_xveclist = list("name" = "x4", min = 219, init = 226, max = 233, dsc1 = 219, dsc2 = 233),
...
NYS_basic_mod <- make_SeroRev_IFR_model_fit(num_mas = 1, maxMa = "ma1",
                                          groupvar = "region",  dat = rawbase,
                                          num_xs = 4, max_xveclist = list("name" = "x4", min = 219, init = 226, max = 233, dsc1 = 219, dsc2 = 233),
                                          num_ys = 5, max_yveclist = list("name" = "y3", min = 0, init = 9, max = 15.94, dsc1 = 0, dsc2 = 15.94),
                                          sens_spec_tbl = sens_spec_tbl_serorev, tod_paramsdf = tod_paramsdf)
