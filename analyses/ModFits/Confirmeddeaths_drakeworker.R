...
# confirmed deaths
#......................
confirmeddeaths <- readRDS("data/derived/confirmeddeaths/GBR3_confirmed_deaths.rds")
...
fit_map <- tibble::tibble(
  name = c("NYC_NY_1_age",
           "NYC_NY_1_confirmeddeath",
           "GBR3_confirmeddeath"),
  modelobj = list(NYC1_all_age_mod,
                  NYC1_confirmed_age_mod,
                  GBR3_confirmeddeaths_mod),
  rungs = 50,
  GTI_pow = list(bvec),
  burnin = 1e4,
  samples = 1e4,
