...
mod1_oneday$set_Knotparams(paste0("x", 1:9))
mod1_oneday$set_Infxnparams(paste0("y", 1:10))
...
mod1_twodays$set_Knotparams(paste0("x", 1:9))
mod1_twodays$set_Infxnparams(paste0("y", 1:10))
