...
sens_spec_tbl <- tibble::tibble(name =  c("sens", "spec", "sero_rate", "sero_day1"),
                                ...
                                max =   c(1.00,    1.00,     2,        143),
                                dsc1 =  c(850.5,   990.5,    0,        136),
                                dsc2 =  c(150.5,    10.5,    2,        143))
#......................
# regions
#......................
...
sens_spec_tbl <- tibble::tibble(name =  c("sens", "spec", "sero_rate", "sero_day1", "sero_day2", "sero_day3", "sero_day4", "sero_day5"),
                                ...
                                max =   c(1.00,    1.00,     2,         104,         111,         118,         124,         131),
                                dsc1 =  c(156.5,   176.5,    0,         97,          104,         111,         118,         124),
                                dsc2 =  c(25.5,    0.5,      2,         104,         111,         118,         124,         131))
#......................
# regions
#......................
...
sens_spec_tbl <- tibble::tibble(name =  c("sens", "spec", "sero_rate", "sero_day1"),
                                ...
                                max =   c(1.00,    1.00,     2,          124),
                                dsc1 =  c(128.5,   647.5,    0,          97),
                                dsc2 =  c(27.5,    4.5,      2,          124))
#......................
# regions
#......................
...
sens_spec_tbl <- tibble::tibble(name =  c("sens", "spec", "sero_rate", "sero_day1", "sero_day2"),
                                ...
                                max =   c(1.00,    1.00,     2,          132,        153),
                                dsc1 =  c(123.5,   156.5,    0,          118,        139),
...
sens_spec_tbl <- tibble::tibble(name =  c("sens", "spec", "sero_rate", "sero_day1"),
                                ...
                                max =   c(1.00,    1.00,     2,          120),
                                dsc1 =  c(990.5,   990.5,    0,          94),
                                dsc2 =  c(10.5,   10.5,      2,          120))
#......................
# regions
#......................
...
sens_spec_tbl <- tibble::tibble(name =  c("sens", "spec", "sero_rate", "sero_day1"),
                                ...
                                max =   c(1.00,    1.00,     2,          106),
                                dsc1 =  c(171.5,   281.5,    0,          92),
                                dsc2 =  c(3.5,     1.5,      2,          106))
#......................
# regions
#......................
